...
// in the positive case it returns the ssautils.Value
// For some instructions like a *ssautils.Call it is requuired to go deeper.
...
// In the positive case the function returns the ssautils.Value.
...
// getPointsToSet returns the pointsToset for a given ssautils.Value
