// taintatticePointer is a taint lattice which also holds the pointer for every ssautils.LatticeTagInterface
package taint
...
// LatticePointer is an instance of PtrInterface and extends Lattice with pointer information
