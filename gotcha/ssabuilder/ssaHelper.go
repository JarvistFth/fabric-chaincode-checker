...
//func (ssautils *SsaForCallgraph) GetProgram()iprog
//// Returns a *ssautils.Programm.
//// The file is parsed against nil.
//func GetProgram(fileName string) (*ssautils.Program, error) {
...
//	}
//
//	prog := ssautil.CreateProgram(iprog, ssautils.SanityCheckFunctions)
//
//	fmt.Print(&buf)
//
//	return prog, nil
