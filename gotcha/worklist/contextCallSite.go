...
// a ssautils.Instruction and the in and out lattice for this node.
...
// node is the ssautils.Instruction for the contextcallsite
...
// Node returns the ssautils.Instruction of c
